          ...
          <div className="toggle-cont">
            ...
            <label className="toggle-label" htmlFor="toggle">
              <div className="cont-icon">
                {[
                  { w: 2, d: 25, dur: 11 }, { w: 1, d: 100, dur: 18 },
                  { w: 1, d: 280, dur: 5 }, { w: 2, d: 200, dur: 3 },
                  { w: 2, d: 30, dur: 20 }, { w: 2, d: 300, dur: 9 },
                  { w: 1, d: 250, dur: 4 }, { w: 2, d: 210, dur: 8 },
                  { w: 2, d: 100, dur: 9 }, { w: 1, d: 15, dur: 13 },
                  { w: 1, d: 75, dur: 18 }, { w: 2, d: 65, dur: 6 },
                  { w: 2, d: 50, dur: 7 }, { w: 1, d: 320, dur: 5 },
                  { w: 1, d: 220, dur: 5 }, { w: 1, d: 215, dur: 2 },
                  { w: 2, d: 135, dur: 9 }, { w: 2, d: 45, dur: 4 },
                  { w: 1, d: 78, dur: 16 }, { w: 1, d: 89, dur: 19 },
                  { w: 2, d: 65, dur: 14 }, { w: 2, d: 97, dur: 1 },
                  { w: 1, d: 174, dur: 10 }, { w: 1, d: 236, dur: 5 },
                ].map((s, i) => (
                  <span
                    key={i}
                    style={{ '--width': s.w, '--deg': s.d, '--duration': s.dur }}
                    className="sparkle"
                  />
                ))}
