...
const ThemeSwitch = ({ theme, toggleTheme }) => {
  // Dark mode bo'lsa ON (yashil neon), Light mode bo'lsa OFF (ko'k)
        ...
        <div className="toggle-wrap">
          ...
          <label className="toggle-track" htmlFor="holo-toggle">
            ...
            <div className="toggle-data">
              <div className="data-text off">KUN</div>
              <div className="data-text on">TUN</div>
...
const StyledWrapper = styled.div`
  /* Navbar ga chiroyli sig'ishi uchun scale qildik */
