...
const ErrorFallback = ({ error, resetError }) => {
  return (
    <StyledWrapper>
      <div className="card">
        <p className="error-message">Texnik Xatolik</p>
        <div className="error-title">
          ...
          <div className="error-item">
            ...
            <span aria-hidden="true" className="error-glitch">500</span>
            <span aria-hidden="true" className="error-glitch error-glitch--secondary">500</span>
          </div>
        </div>
        <div className="error-description">
          {error?.message || "Dasturda kutilmagan texnik xatolik yuz berdi"}
        </div>
...
const StyledWrapper = styled.div`
  width: 100vw;
  height: 100vh;
  background: linear-gradient(135deg, #02012a, #05062d);
  display: flex;
  align-items: center;
